module.exports =
  ...
  auth:
    github:
      ...
      callbackURL: "http://theminecraftfiles.com/auth/github/callback"
    ...
    twitter:
      ...
      callbackURL: process.env.AUTH_TWITTER_CALLBACK or "http://theminecraftfiles.com/auth/twitter/callback"
